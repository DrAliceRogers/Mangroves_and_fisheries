...
set_param<-function(){
  ...
  param$A.u = 6.4
  param$A.v= 0.1# 0.2 #param$A.u_reef / 10               #Yearly rate volume searched by invertebrates (should be 10x less than predators?)
  ...
  param$max.fishing.size=3    #Maximum log10 body size fished
  ...
  param$invert.prod = 2#(10^-0.49) # 5.4
  ...
  param$tmaxyears=200#50#200#100.0                           #Maximum number of years for model run
...
#------------------------------------------------------------------------
# New parameters associated with fish originating from nursery habitats
  
  #Minimum and maximum sizes of fish from nurseries
  param$x1.pred.supp = 0.6        #Minimum log10 body size of predators entering reef from nursery habitat
  param$xmax.pred.supp = 2.2    #Maximum log10 body size of predators entering reef from nursery habitat
  param$x1.herb.supp = 0.6        #Minimum log10 body size of herbivores entering reef from nursery habitat
  param$xmax.herb.supp = 2.2    #Maximum log10 body size of herbivores entering reef from nursery habitat
  
  #Location within size spectra of minimum and maximum sized fish from nurseries
  param$ref.x1psup = ((param$x1.pred.supp-param$xmin)/param$dx)+1
  param$ref.xmaxpsup = ((param$xmax.pred.supp-param$xmin)/param$dx)+1
  param$ref.x1hsup = ((param$x1.herb.supp-param$xmin)/param$dx)+1
  param$ref.xmaxhsup = ((param$xmax.herb.supp-param$xmin)/param$dx)+1
  
  #Whole spectrum of additions to assign value to 
  param$supp_preds = 0
  param$supp_herbs = 0
